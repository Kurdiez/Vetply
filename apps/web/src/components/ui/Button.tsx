...
const variantClassNames = {
  ...
  danger:
    'items-center justify-center rounded-md bg-danger-500 px-3.5 py-2.5 text-sm font-semibold text-white shadow-xs hover:bg-danger-400 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-danger-500',
} as const;
