...
type DashboardShellProps = {
  ...
  sidebar?: ReactNode | ((ctx: DashboardSidebarRenderContext) => ReactNode);
};
...
export function DashboardShell({
  ...
  const topBarToneClasses =
    topBarVariant === 'admin'
      ? 'border-b border-primary-500/35 bg-primary-700 shadow-[inset_0_1px_0_0_rgba(53,134,97,0.14)]'
    ...
    <div className="min-h-screen w-full min-w-0 overflow-x-hidden bg-gray-900">
      ...
      <div className="lg:pl-72">
        ...
        >
          ...
          <div aria-hidden className="h-6 w-px bg-white/10 lg:hidden" />
            ...
            {topBarTitle ? (
              <p
                className={classNames(
                  ...
                  topBarVariant === 'admin' ? 'text-primary-100' : 'text-white',
                )}
              >
                {topBarTitle}
              </p>
