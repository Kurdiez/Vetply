...
export class Initial1775963620926 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "catalogue_product_variants" ADD CONSTRAINT "FK_364eb63cf541fb3a8b3c0c3db96" FOREIGN KEY ("product_id") REFERENCES "catalogue_products"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "catalogue_variant_supplier_listings" ADD CONSTRAINT "FK_0fa7680c7d72c885bf8aa9c4b47" FOREIGN KEY ("variant_id") REFERENCES "catalogue_product_variants"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "catalogue_variant_supplier_listings" ADD CONSTRAINT "FK_aa606ddbdd17b272746bc2af0a7" FOREIGN KEY ("supplier_id") REFERENCES "catalogue_suppliers"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "catalogue_variant_supplier_listings" DROP CONSTRAINT "FK_aa606ddbdd17b272746bc2af0a7"`,
    );
    await queryRunner.query(
      `ALTER TABLE "catalogue_variant_supplier_listings" DROP CONSTRAINT "FK_0fa7680c7d72c885bf8aa9c4b47"`,
    );
    await queryRunner.query(
      `ALTER TABLE "catalogue_products" DROP CONSTRAINT "FK_700b1ba20872c935f6901fd00ac"`,
    );
    await queryRunner.query(
      `ALTER TABLE "catalogue_product_variants" DROP CONSTRAINT "FK_364eb63cf541fb3a8b3c0c3db96"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_catalogue_products_name"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_catalogue_products_sales_category"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_catalogue_products_legal_category"`,
    );
    await queryRunner.query(`DROP INDEX "public"."IDX_catalogue_products_pom"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_catalogue_products_updated_at_id"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_catalogue_product_variants_product_id"`,
    );
